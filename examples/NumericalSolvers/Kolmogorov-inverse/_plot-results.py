...
plt.savefig('figures/fig_WeighedLaplace_RHS.pdf', format='pdf', bbox_inches='tight')
plt.close(fig)
...
ax.set_ylabel(r'$V_1$')
pdf.savefig(fig, bbox_inches='tight')
plt.savefig('figures/fig_WeighedLaplace_Solution.pdf', format='pdf', bbox_inches='tight')
plt.close(fig)
pdf.close()
