...
int main(int argc, char **argv) {
  // the output filename
  const std::string filename = "output/inelastic-collisions/output";

  // create the conditional velocity distribution
  auto distribution = std::make_shared<VaryCollisionEnergy>(0.5, VaryCollisionEnergy::Options(filename));
