...
int main(int argc, char **argv) {
  // the output filename
  const std::string filename = "output/elastic-collisions/output";

  // create the conditional velocity distribution
  auto distribution = std::make_shared<VaryCollisionEnergy>(1.0, VaryCollisionEnergy::Options(filename));
