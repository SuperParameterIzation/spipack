...
// =============================---==============
#ifndef __CompressibleEulerSolver_FV_Variables_CLASS_HEADER__
#define __CompressibleEulerSolver_FV_Variables_CLASS_HEADER__
 ...
 * specification file
 **/
struct CompressibleEuler::AbstractCompressibleEulerSolver_FV::VariableMetrics {
 ...
 **/
class CompressibleEuler::AbstractCompressibleEulerSolver_FV::VariableShortcuts : public CompressibleEuler::AbstractCompressibleEulerSolver_FV::VariableMetrics {
public:
 ...
 **/
class CompressibleEuler::AbstractCompressibleEulerSolver_FV::VariableMultiplicities : public CompressibleEuler::AbstractCompressibleEulerSolver_FV::VariableMetrics {
public:
  /// positions of fields inside the unknown vector (solution vector) Q
 ...
 *
 **/
class CompressibleEuler::AbstractCompressibleEulerSolver_FV::VariableNames : public CompressibleEuler::AbstractCompressibleEulerSolver_FV::VariableMetrics {
public:
 ...
 * 
 *    void somewhere() {
 *       using namespace CompressibleEuler::CompressibleEulerSolver_FV_Variables::shortcuts;
 *       Q[foo] = 17;
 *    }
 *
 * instead of
 * 
 *    void somewhere() {
 *       CompressibleEuler::AbstractCompressibleEulerSolver_FV::VariableNames q;
 *       Q[q.foo] = 17;
 *    }
 *
 **/
namespace CompressibleEuler {
  namespace CompressibleEulerSolver_FV_Variables {
    namespace shortcuts {
      constexpr int rho = 0;
      constexpr int j = 1;
      constexpr int E = 4;
  ...
  } // end of namespace CompressibleEuler::CompressibleEulerSolver_FV_Variables 
...
class CompressibleEuler::AbstractCompressibleEulerSolver_FV::ReadOnlyVariables : public CompressibleEuler::AbstractCompressibleEulerSolver_FV::VariableMetrics {
  private:
...
class CompressibleEuler::AbstractCompressibleEulerSolver_FV::Variables : public CompressibleEuler::AbstractCompressibleEulerSolver_FV::VariableMetrics{
  private:
    double* const _Q;
  public:
    static constexpr int SizeVariables  = 5;
...
class CompressibleEuler::AbstractCompressibleEulerSolver_FV::Fluxes : public CompressibleEuler::AbstractCompressibleEulerSolver_FV::VariableMetrics {
  private:
    double** const _F;
  public:
...
// Global Observables
//
class CompressibleEuler::AbstractCompressibleEulerSolver_FV::ReadOnlyGlobalObservables {
  private:
...
class CompressibleEuler::AbstractCompressibleEulerSolver_FV::GlobalObservables {
  private:
