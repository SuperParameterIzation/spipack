 ...
 * specification file
 **/
struct Boltzmann::AbstractBoltzmannSolver_ADERDG::VariableMetrics {
 ...
 **/
class Boltzmann::AbstractBoltzmannSolver_ADERDG::VariableShortcuts : public Boltzmann::AbstractBoltzmannSolver_ADERDG::VariableMetrics {
public:
 ...
 **/
class Boltzmann::AbstractBoltzmannSolver_ADERDG::VariableMultiplicities : public Boltzmann::AbstractBoltzmannSolver_ADERDG::VariableMetrics {
public:
  /// positions of fields inside the unknown vector (solution vector) Q
 ...
 *
 **/
class Boltzmann::AbstractBoltzmannSolver_ADERDG::VariableNames : public Boltzmann::AbstractBoltzmannSolver_ADERDG::VariableMetrics {
public:
 ...
 * 
 *    void somewhere() {
 *       using namespace Boltzmann::BoltzmannSolver_ADERDG_Variables::shortcuts;
 *       Q[foo] = 17;
 *    }
 *
 * instead of
 * 
 *    void somewhere() {
 *       Boltzmann::AbstractBoltzmannSolver_ADERDG::VariableNames q;
 *       Q[q.foo] = 17;
 *    }
 *
 **/
namespace Boltzmann {
  ...
  } // end of namespace Boltzmann::BoltzmannSolver_ADERDG_Variables 
...
class Boltzmann::AbstractBoltzmannSolver_ADERDG::ReadOnlyVariables : public Boltzmann::AbstractBoltzmannSolver_ADERDG::VariableMetrics {
  private:
...
class Boltzmann::AbstractBoltzmannSolver_ADERDG::Variables : public Boltzmann::AbstractBoltzmannSolver_ADERDG::VariableMetrics{
  private:
    double* const _Q;
  public:
    static constexpr int SizeVariables  = 5;
...
class Boltzmann::AbstractBoltzmannSolver_ADERDG::Fluxes : public Boltzmann::AbstractBoltzmannSolver_ADERDG::VariableMetrics {
  private:
    double** const _F;
  public:
...
// Global Observables
//
class Boltzmann::AbstractBoltzmannSolver_ADERDG::ReadOnlyGlobalObservables {
  private:
...
class Boltzmann::AbstractBoltzmannSolver_ADERDG::GlobalObservables {
  private:
