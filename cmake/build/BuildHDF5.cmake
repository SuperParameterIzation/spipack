...
ExternalProject_Add(
  HDF5
    ...
    CONFIGURE_COMMAND CC=${CMAKE_C_COMPILER} CXX=${CMAKE_CXX_COMPILER} CPPFLAGS=${CMAKE_CXX_FLAGS} ${CMAKE_CURRENT_BINARY_DIR}/external/hdf5/src/HDF5/hdf5-${SPIPACK_INTERNAL_HDF5_VERSION}/configure ${HDF5_PARALLEL_FLAG} --prefix=${CMAKE_BINARY_DIR}/external/hdf5 --enable-production --disable-examples
